...
namespace PER.Abstractions.Renderer {
    ...
    public readonly struct BlendMode : IEquatable<BlendMode> {
        ...
        public override int GetHashCode() => colorSrcFactor.GetHashCode() ^ colorDstFactor.GetHashCode() ^
                                             colorEquation.GetHashCode() ^ alphaSrcFactor.GetHashCode() ^
                                             alphaDstFactor.GetHashCode() ^ alphaEquation.GetHashCode();
