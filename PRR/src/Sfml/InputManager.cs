    ...
    public class InputManager : IInputManager {
        ...
        private void UpdateMousePosition(int mouseX, int mouseY) {
            ...
            accurateMousePosition = new Vector2(
                (mouseX - renderer.window.Size.X * 0.5f + renderer.text.imageWidth * 0.5f) / renderer.font.size.x,
                (mouseY - renderer.window.Size.Y * 0.5f + renderer.text.imageHeight * 0.5f) / renderer.font.size.y);
