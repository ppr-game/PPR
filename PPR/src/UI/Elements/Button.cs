...
namespace PPR.UI.Elements {
    public class Button : Element {
        ...
        public Button(string id, List<string> tags, Vector2i? position, int width, Vector2f? anchor, Element parent,
        ...
        private State GetState() {
            ...
            if(mask == null) {
                ...
                wasOnButton = UI.Manager.LineSegmentIntersection(UI.Manager.prevMousePosition, Core.renderer.mousePosition,
