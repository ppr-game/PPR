    ...
    public class Slider : Element {
        ...
        public int value {
            ...
            set {
                ...
                Lua.Manager.InvokeEvent(this, "sliderValueChange", this, DynValue.NewNumber(value),
        ...
        public Slider(string id, List<string> tags, Vector2i? position, int width, Vector2f? anchor, Element parent,
        ...
        private State DrawBase(Func<Vector2i, RenderCharacter, (Vector2i, RenderCharacter)> modifier) {
            ...
            if(mask == null) {
                ...
                wasOnSlider = UI.Manager.LineSegmentIntersection(UI.Manager.prevMousePosition, Core.renderer.mousePosition,
